...
const blockTextureDiffuse = await glance.loadTextureNow(gl, "./ECG_Alex/Tetrix/img/block_diffuse.png")
const blockTextureSpecular = await glance.loadTextureNow(gl, "./ECG_Alex/Tetrix/img/block_specular.png")
