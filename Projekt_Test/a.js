...
const blockTextureAmbient = await glance.loadTextureNow(gl, "./ECG_Alex/Projekt_Test/img/block_ambient.png")
const blockTextureDiffuse = await glance.loadTextureNow(gl, "./ECG_Alex/Projekt_Test/img/block_diffuse.png")
const blockTextureSpecular = await glance.loadTextureNow(gl, "./ECG_Alex/Projekt_Test/img/block_specular.png")
